...
from experiment_configs import print_resolved_config, resolve_gymnax_generic_config
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = resolve_gymnax_generic_config(args.env_id, run_preset=args.run_preset, overrides=overrides)
    if args.print_config:
        print_resolved_config(config, family="control.gymnax_generic", run_preset=args.run_preset)
        return 0
