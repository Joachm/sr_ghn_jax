...
from experiment_configs import print_resolved_config, resolve_ant_brax_config
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = resolve_ant_brax_config(run_preset=args.run_preset, overrides=overrides)
    if args.print_config:
        print_resolved_config(config, family="control.ant_brax", run_preset=args.run_preset)
        return 0
